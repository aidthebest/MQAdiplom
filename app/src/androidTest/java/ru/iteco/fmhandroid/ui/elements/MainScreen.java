...
public class MainScreen {
    ...
    public ViewInteraction maiMenuImageButton = onView(allOf(withId(R.id.main_menu_image_button)));

    public ViewInteraction claimsButton = onView(
    ...
    public ViewInteraction mainsButton = onView(
